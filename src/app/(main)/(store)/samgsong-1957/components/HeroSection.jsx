...
export default function HeroSection() {
  ...
  return (
    <>
      ...
      {/* 소개 섹션 */}
      <section className="py-33 bg-gray-50 pt-[130px]">
        <div className="container px-4 mx-auto">
          <div className="flex justify-center mb-8" data-aos="flip-left" data-aos-delay="200">
            <img src="/icons/(store)/brand5-s1957.png" alt="SAMSONG 1957 로고" className="w-auto h-47" />
          </div>
          <p className="mb-20 text-xl text-center text-black" data-aos="fade-up" data-aos-dalay="400">
